...
(defn run [_]
  (let [doid-dbXref (hasDbXref "stage_0_outputs/doid.csv")
        ...
        icd9-dbXref (hasDbXref "stage_0_outputs/icd9.csv")
        icd10-dbXref (hasDbXref "stage_0_outputs/icd10.csv")
        icd11-dbXref (hasDbXref "stage_0_outputs/icd11.csv")
        kegg-dbXref (hasDbXref "stage_0_outputs/kegg.csv")
        medgen-dbXref (hasDbXref "stage_0_outputs/medgen.csv")
        mondo-dbXref (hasDbXref "stage_0_outputs/mondo.csv")
        ncit-dbXref (hasDbXref "stage_0_outputs/ncit.csv")
        orphanet-dbXref (hasDbXref "stage_0_outputs/orphanet.csv")
        snomedct-dbXref (hasDbXref "stage_0_outputs/snomedct.csv")
